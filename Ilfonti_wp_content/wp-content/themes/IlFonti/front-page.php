<?php get_header(); ?>
    <body>
        ...
        ?>
        <header>
            <a class="" href="http://ilfonti.test">
        ...
        <div class="carousel slide wow fadeIn" data-ride="carousel" data-wow-delay=".2s" id="carouselExampleInterval" style="margin-top: 20px;">
            <div class="carousel-inner">
                <div class="carousel-item active" data-interval="5000">
                    <img alt="..." class="d-inline w-50" src="<?php echo get_template_directory_uri() . '/assets/img/sitio/pizza.jpg'?>" style="float: left;"/>
                    <img alt="..." class="d-inline w-50" src="<?php echo get_template_directory_uri() . '/assets/img/sitio/il_fonti_di_modena.jpg'?>" style="float: left;"/>
                </div>
                <div class="carousel-item" data-interval="2000">
                    <img alt="..." class="d-inline w-50" src="<?php echo get_template_directory_uri() . '/assets/img/sitio/mesas.jpg'?>" style="float: left;"/>
                    <img alt="..." class="d-inline w-50" src="<?php echo get_template_directory_uri() . '/assets/img/sitio/pasta.jpg'?>" style="float: left;"/>
                </div>
            </div>
